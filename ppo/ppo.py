...
class ActorCritic(nn.Module):
    def __init__(self, state_dim, action_dim, has_continuous_action_space, action_std_init):
        ...
        # actor linear layers
        self.actor_fc1 = nn.Linear(65, 512)  # Add +1 for the scalar input
...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, image_observation, action_std_init=0.6):
